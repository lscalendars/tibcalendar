...
\hline
\multicolumn{1}{|c|}{\textbf{Celestial body}} & \multicolumn{1}{c|}{\textbf{$r_{min}$ (km)}} & \multicolumn{1}{c|}{\textbf{$v_{max}$ (km/s)}} \\\hline
Sun & 1.47e8 & 30.29\\\hline % mean: 150km
Moon & 3.63e5 & 1.08\\\hline % mean: 385kkm ; the Internet often gives the value 3.56, never seen a source about this
Mercury & 7.7e7 & 58.98\\\hline % mean: 100Mkm
Mars & 5.5e7 & 26.5\\\hline % mean: 225Mkm
Venus & 3.8e7 & 35.26\\\hline % mean: 150Mkm
Saturn & 1.2e9 & 10.18\\\hline % mean: 1450Mkm
Jupiter & 5.9e11 & 13.71\\\hline % mean: 770kMkm
\end{tabular}
\caption{Planet caracteristics used in the calculations}
